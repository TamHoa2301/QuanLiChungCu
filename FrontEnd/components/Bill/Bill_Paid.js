...
const Bill_Paid = ({ navigation, route }) => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://tuantunguyenq23.pythonanywhere.com/users/${userId.id}/get-bills-paid/`);
